 ...
 * @param  [out] h      | Camera handle
 * @param  [in]  nn_buf | NN buffer base address (0 = use default CAM_NN_BUF)
 * @retval CAM_OK       | Success
 * @retval CAM_ERROR    | Unspecified error
 * @retval CAM_ERROR_ID | IMX335 probe/ID failure
 * @retval CAM_ERROR_INIT | IMX335 init failure
 */
 ...
 * @retval CAM_OK    | Success
 * @retval CAM_ERROR | Sensor start failure
 */
