...
CAM_Status CAM_Init(CAM_Handle *h)
{
    ...
    DCMIPP_Pipe_cfg_TypeDef pipe_conf;
    DCMIPP_IPPlug_cfg_TypeDef ipplug_conf;
    ...
    pipe_conf = DCMIPP_display_pipe_cfg;
    ...
    ipplug_conf = DCMIPP_IPPlug_client2_cfg;
    DCMIPP_IPPlug_Config(&ipplug_conf);

    /* IPC5 => CLIENT4:        R1=0x024  R2=0x0   R3=0x27f0230 */
    ipplug_conf = DCMIPP_IPPlug_client4_cfg;
    DCMIPP_IPPlug_Config(&ipplug_conf);
