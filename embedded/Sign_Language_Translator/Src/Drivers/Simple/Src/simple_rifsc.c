...
void RIFSC_Config(void)
{
	...
	_RIFSC_SetSlaveSecureAttributes(RIFSC_RISC_PERIPH_INDEX_I2C2,    RIFSC_ATTRIBUTE_SEC | RIFSC_ATTRIBUTE_PRIV);
	_RIFSC_SetSlaveSecureAttributes(RIFSC_RISC_PERIPH_INDEX_I2C3,    RIFSC_ATTRIBUTE_SEC | RIFSC_ATTRIBUTE_PRIV);
	_RIFSC_SetSlaveSecureAttributes(RIFSC_RISC_PERIPH_INDEX_I2C4,    RIFSC_ATTRIBUTE_SEC | RIFSC_ATTRIBUTE_PRIV);
