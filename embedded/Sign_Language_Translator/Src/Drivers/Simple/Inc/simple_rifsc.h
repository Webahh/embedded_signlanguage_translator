...
#define RIFSC_RISC_PERIPH_INDEX_I2C2       (RIFSC_PERIPH_REG0 | RIFSC_RISC_SECCFGRx_SEC10_Pos)
#define RIFSC_RISC_PERIPH_INDEX_I2C3       (RIFSC_PERIPH_REG0 | RIFSC_RISC_SECCFGRx_SEC11_Pos)
#define RIFSC_RISC_PERIPH_INDEX_I2C4       (RIFSC_PERIPH_REG0 | RIFSC_RISC_SECCFGRx_SEC12_Pos)
